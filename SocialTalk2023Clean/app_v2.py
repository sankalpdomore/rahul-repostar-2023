...
model = KeyedVectors.load_word2vec_format("wheel_model_clean.bin")
...
positive_dropdown = dcc.Dropdown(
    ...
    value=['Interest:Luxury-Goods', 'Interest:Cars-&-Motorbikes', 'Country:Italy'],
    multi=True,
    id='positive-terms'
)
...
if __name__ == "__main__":
    app.run_server(debug=True, host="0.0.0.0", port=5001, use_reloader=True)
